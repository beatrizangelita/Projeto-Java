...
public static void main(String[] args) {
		...
		System.out.println("\n                  Obrigada pelas informações "+ Cores.TEXT_YELLOW_BRIGHT + firstUser.getNome()+ Cores.TEXT_RESET+ "! Agora vamos te apresentar o nosso menu: ");
		System.out.println(Cores.TEXT_RESET);
		do {
			...
			case 5:
				...
				do {
					...
					case 1:
						System.out.println(firstUser.infoPessoal());
						System.out.println("**********************************************");
						...
						if (porPoupanca >= 10) {
							...
							System.out.println(" O tio Patinhas está desapontado! Você nao guardou o suficiente para emergencias. "
									+ "\n Recomendamos que releia as preciosas dicas do Tio Patinhas!\n");
						}
						...
						if (porInv >= 10) {
							...
							System.out.println(" O tio Patinhas está desapontado! Você nao atingiu o valor a ser investido esse mes. "
									+ "\n Recomendamos que releia as preciosas dicas do Tio Patinhas!\n");
						}
