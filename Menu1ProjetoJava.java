...
public static void main(String[] args) {
		...
		System.out.println("\n                           Qual a sua idade? ");
		idade = leia.nextInt();
		System.out.println("\n                  Obrigada pelas informações "+ Cores.TEXT_YELLOW_BRIGHT + nome+ Cores.TEXT_RESET+ "! Agora vamos te apresentar o nosso menu: ");
		System.out.println(Cores.TEXT_RESET);
		do {
			...
			case 5:
				...
				do {
					...
					case 1:
						...
						System.out.println(Cores.TEXT_WHITE_BOLD+"*************************************************************************************************" + Cores.TEXT_RESET);
